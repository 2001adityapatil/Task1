...
function saveValuesToSheet(date, value1, value2, value3, value4, value5, value6) {
  ...
  sheet.getRange(lastRow, 2).setValue(value1);
  sheet.getRange(lastRow, 3).setValue(value2);
  sheet.getRange(lastRow, 4).setValue(value3);
  sheet.getRange(lastRow, 5).setValue(value4);
  sheet.getRange(lastRow, 6).setValue(value5);
  sheet.getRange(lastRow, 7).setValue(value6);
}
